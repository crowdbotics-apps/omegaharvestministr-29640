...
## Project Structure
    ...
    ├── omegaharvestministr_29640  # Django project configurations
...
1. Clone this repo and `cd omegaharvestministr_29640`
...
2. Clone this repo and `cd omegaharvestministr_29640`
